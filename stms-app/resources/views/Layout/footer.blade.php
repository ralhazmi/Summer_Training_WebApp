...
<footer class="bg-white rounded-lg shadow m-4 fixed bottom-0 w-9/12">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            ...
            <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 sm:mt-0">
                <li>
                    <div class="flex items-center justify-between" style="background-color:#F5F7FA;">
                        <div class="flex items-center justify-start rtl:justify-end">
                        <p class="flex items-center text-sm text-gray-500 ">الدعم الفني<button data-popover-target="popover-description" data-popover-placement="bottom-end" type="button"><svg class="text-gray-3v00" width="20" height="20" viewBox="0 0 22 22"   aria-hidden="true" fill="currentColor"  xmlns="http://www.w3.org/2000/svg">
